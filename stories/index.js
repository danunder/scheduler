...
storiesOf("Appointment", module)
  ...
  .add("Edit", () => <Form name="Hilda P Jackson" interviewers={interviewers} interviewer={4} onSave={action("onSave")} onCancel={action("onCancel")} />)
  ...
  .add("Appointment Booked", () => (
    <Fragment>
      <Appointment
        id={1}
        time="12pm"
        interview={{ student: "Lydia Miller-Jones", interviewer: "JOSS THE BOSS"  }}
      />
      <Appointment id="last" time="1pm" />
    </Fragment>
  ))